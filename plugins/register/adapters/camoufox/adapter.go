// Package camoufox implements BrowserAutomator via a Python Camoufox subprocess.
...
func (a *Automator) Name() string { return "camoufox" }

func (a *Automator) Launch(_ context.Context, _ register.LaunchOpts) (register.BrowserSession, error) {
	a.log.Warn("camoufox: Launch not implemented — subprocess bridge pending")
	return nil, fmt.Errorf("camoufox adapter not implemented")
}
